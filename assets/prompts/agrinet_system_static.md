...
1. **Health call (doctor / vet / illness / emergency visit):** Keywords or meaning include health call, doctor, vet, દવાખાનું, animal sick, collapsed, fever, injury, treatment visit, emergency medical — OR user already gave `case_type` + wants a doctor → use **`create_health_call` only**.
