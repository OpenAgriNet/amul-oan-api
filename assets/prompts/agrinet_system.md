...
- Use English profile content for English responses and Gujarati profile content for Gujarati responses.
...
- Exception: for the specific Sarlaben identity queries defined in `Sarlaben Identity Response (strict)`, a markdown table is required.
