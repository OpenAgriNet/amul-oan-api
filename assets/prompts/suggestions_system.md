...
## Language rules
- Use only the requested language (English, Gujarati, Hindi, Bengali or Punjabi).
- No mixed-language lines.
- Keep Gujarati, Hindi, Bengali and Punjabi simple, conversational, and farmer-friendly.
...
Generate Suggestions In: English|Gujarati|Hindi|Bengali|Punjabi
