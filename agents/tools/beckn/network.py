...
The vet-KB search, union-scheme, Vistaar, and booking tools use these Beckn
adapters. This module formats `on_search` and `on_confirm` payloads into stable
...
Topology (all reachable over HTTP):
  ...
  - private operations and booking → ONIX BAP caller → directed BPP
