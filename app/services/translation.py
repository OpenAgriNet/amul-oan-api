...
def _canned_union_ban_translation(text: str, target_lang: str) -> str | None:
    ...
    Punjabi copy is fixed.
    Already-localized GU/HI/BN/PA canned lines pass through as the target-lang variant.
    """
...
def _prepare_translation_inputs(text, source_lang, target_lang, max_output_chars):
    ...
    logic (mini glossary for gu/hi/bn/pa at threshold 0.90 / max 40)."""
    mini_glossary = ""
    if target_lang.lower() in ("gujarati", "gu", "hindi", "hi", "bengali", "bn", "punjabi", "pa"):
